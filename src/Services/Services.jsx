...
import { MdCode,MdVideoCameraBack,MdMemory,MdTerminal } from 'react-icons/md';
  ...
  return (
    <div className="services-section">
    	<div className="services-head">
    		<h1>What I <span>Build & Fix</span></h1>
    		<p>Comprehensive tech services for businesses and individuals. From code to hardware, I've got you covered.</p>	
    	</div>
        ...
        <service.icon size={30} color="#007bff" /> 
              ...
              <div className="service-name"><h1>{service.name}</h1></div>
              <div className="service-info"><p>{service.info}</p></div>
